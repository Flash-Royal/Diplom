...
class SuperVis():
    def __init__(self, robotName, timestep):
        ...
        self.supervisorNode = self.supervisor.getFromDef('Supervisor')
...
while robotVis.supervisor.step(timeStep) != -1:
    ...
    if robotVis.receive() == '1':
        ...
        #robotVis.supervisor.simulationReset()
        #robotVis.robotNode.restartController()
        robotVis.supervisorNode.restartController()
    else:
